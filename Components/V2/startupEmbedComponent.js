...
/**
 * Genera un componente V2 de arranque bonito para Moxi, estilo ping pero sin botón
 * @param {import('discord.js').Client} client
 * @returns {ContainerBuilder}
 */
function getStartupComponentV2(client) {
...
module.exports = { getStartupComponentV2 };